...
const searchInput = document.getElementById('Your input id'); // ---| input box id |---
const productNames = document.querySelectorAll('Your products name of class'); // ---| product className to find |---
